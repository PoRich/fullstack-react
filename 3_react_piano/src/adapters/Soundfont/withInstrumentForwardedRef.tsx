    ...
    WrappedComponent: ComponentClass<TProps>){
        ...
        class WithInstrument extends Component<WithForwardedRef, ProviderState> {
            ...
            public render(){
                ...
                return (
                    <WrappedComponent ref={forwardedRef} {...(injected as TProps)} />
                    )
            }   
        }
        // By default refs are not provided as all other props. In order to get
        // access to a ref, we have to call a special forwardRef() function
